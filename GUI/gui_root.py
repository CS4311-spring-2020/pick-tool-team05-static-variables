...
from PyQt5.QtWidgets import QDesktopWidget, QMainWindow, QAction, qApp, QMenu, QWidget, QSizePolicy
...
class Root(QMainWindow):
    ...
    def setFileMenu(self, file_menu):
        # (TODO): Add triggers
        connect_act = QAction(QIcon('connect.png'), '&Connect...', self)
        connect_act.setShortcut('Ctrl+Shift+C')
        connect_act.setStatusTip('Connect to host')
        file_menu.addAction(connect_act)

        # (TODO): Add triggers
        disconnect_act = QAction(QIcon('disconnect.png'), '&Disconnect...', self)
        ...
        # (TODO): Add triggers
        files_act = QAction(QIcon('files.png'), '&View Log Files...', self)
    ...
    def setEditMenu(self, edit_menu):
        # (TODO): Add triggers
        add_act = QAction(QIcon('add.png'), '&Add Vector...', self)
        add_act.setShortcut('Ctrl+Shift+N')
        add_act.setStatusTip('Add vector')
        edit_menu.addAction(add_act)

        # (TODO): Add triggers
        del_act = QAction(QIcon('delete.png'), '&Delete Vector', self)
        ...
        # (TODO): Add triggers
        export_act = QAction(QIcon('export.png'), '&Export Graph...', self)
    ...
    def setHelpMenu(self, help_menu):
        ...
        help_act = QAction(QIcon('help.png'), '&Help', self)
        ...
        about_act = QAction(QIcon('question.png'), '&About', self)
        about_act.setStatusTip('About PMR Insight Collective Knowledge Tool')
        help_menu.addAction(about_act)

    # (TODO): Add more icons according to future developments
    # (TODO): Complete adding basic icons
    def initToolBar(self):
        toolbar = self.addToolBar('Toolbar')
        toolbar.setMovable(False)
        toolbar.setIconSize(QSize(20, 20))
        toolbar.setStyleSheet("QToolBar{padding-left:0px;}")
